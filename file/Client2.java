...
public class Client2 {
	...
	public static void main(String[] args) throws Exception {
		...
		long endtimefinal;
		System.out.println("Start time "+ starttimefinal);
		//test2();
       ...
       long timetaken;
        ...
        System.out.println("End time "+ endtimefinal);
        System.out.println("time taken "+(endtimefinal-starttimefinal));
	}
	
	public static void test2(int id, String name)throws NoSuchAlgorithmException,
	KeyManagementException, ParseException{
		...
		try {
			...
			URL url = new URL("https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol="+name+"&interval=5min&outputsize=full&apikey=J27JKP9HNK701478");
		...
		//"https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=AMZN&interval=5min&apikey=J27JKP9HNK701478");
			...
			System.out.println("Size of Timezone List for Thread Id |"+ id+ "Name |"+name+"->" + obj.getTimezoneList().size());
		}catch(Exception e){
			e.printStackTrace();
			System.out.println("exceptio occurs");
	...
	private static void test() throws NoSuchAlgorithmException,
		...
		try {
			...
			URL url = new URL("https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=HDFC.ns&interval=5min&outputsize=full&apikey=J27JKP9HNK701478");
				//	"https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=AMZN&apikey=J27JKP9HNK701478");
		//"https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=AMZN&interval=5min&apikey=J27JKP9HNK701478");
			/*
			 * URL url = new URL(
